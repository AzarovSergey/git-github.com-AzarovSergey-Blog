...
namespace CustomAuth.Controllers
{
    ...
    {
        private readonly IUserService _repository = (IUserService)System.Web.Mvc.DependencyResolver.Current.GetService(typeof(IUserService));
        ...
        {
            var anyUser = _repository.GetAllUserEntities().Any(u => u.Login.Contains(viewModel.Login));
